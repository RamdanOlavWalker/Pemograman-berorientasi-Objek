...
public class MainSetdanGet {
    public static void main(String[] args){
        ...
        total_harga=a+b+c;
        /*ini adalah metode untuk menjumlahkan seluruh harga jika penjual
        mampu menjual seluruh barang jualannya. pertama tama menyimpan dulu 
        total masing2 harga barang tersebut dalam int a, b dan c. kemudian 
        dijumlahkan
        */
        
        System.out.println("\nJadi, total semua harga jika penjual mampu");
        System.out.println("menjual semua barangnya adalah "+ total_harga);
    }
